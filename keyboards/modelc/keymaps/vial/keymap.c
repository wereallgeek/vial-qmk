...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    ...
    // CTRL                                                                                              @          +        -      HOME
    KC_LCTL, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_AT,   KC_PPLS, KC_PMNS, KC_HOME,            KC_F2,
    
    // PAUSE                                                                                               :         ;        *      ENTER
    KC_PAUS,           KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_COLN, KC_SCLN, KC_PAST, KC_ENT,             KC_F3,
    
    // WIN     shift                                                                     ,      .        /          britishpound       =                F4
    KC_LGUI, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_HASH,  KC_EQL,             KC_F4,
